    ...
    <div style="height: 76%; background-image: url(/picture/index.jpg); background-size: cover">
        <div class="container col-4 rounded" style="background-color: #3B3B3B">
            <form method="post" action="/controller">
                ...
                <p style="color: #c69500">
                    <fmt:message key="info"/>: <input class="form-control" style="background-color: #BABABA" type="text" name="info" pattern="^[\p{L}\s\.\-]{0,300}$" placeholder="<fmt:message key="info"/>" value="${info}">
                </p>
                <p style="color: #c69500">
                    <c:choose>
